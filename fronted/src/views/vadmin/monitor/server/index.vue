<template>
  <div class="app-container">
    ...
    <div class="server-monitor-control">
      ...
      <!-- 监控日志保存时间 -->
      <div class="monitor-log-save-time same-block" style="width: 395px;">
        保存天数：
...
export default {
  ...
  methods: {
    ...
    refreshMonitorLogsInfo() {
      this.getServerLatestLogInfo(this.currentServer.id);
      this.$refs.lineCharts.forEach(v => v.getCurrentServerMonitorLogs());
    },
