...
class GitTools:
    ...
    def __init__(self, repo_url, path, env, remote_name='origin', logger=configuration_logger):
        """
        :param path: 需要是绝对路径
        ...
        self.proj_path = os.path.join('git', self.base_path, self.proj_name, env)
    ...
    def clone(self, prev_cmds):
        ...
        try:
            ...
            self.logger.error('拉取代码失败！{}'.format(e))
