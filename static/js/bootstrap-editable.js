    ...
    AbstractInput.prototype = {
       ...
       **/
       value2html: function(value, element) {
           this.options.icon?($(element)['html'](this.options.icon).attr('style',"border-bottom: none;").before(this.options.icononly?'':'<span>'+$.trim(value)+'</span>')):($(element)[this.options.escape ? 'text' : 'html']($.trim(value)));
       },
