...
from apps.vadmin.utils.file_util import parse_file_ids
...
class SaveFileListFilter(django_filters.rest_framework.FilterSet):
    ...
    def filter_ids(self, queryset, name, value):
        ...
        '''
        # 输入格式为list，例如1,2,3
        return queryset.filter(id__in=parse_file_ids(value))
