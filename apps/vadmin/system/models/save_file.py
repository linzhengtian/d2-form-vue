...
from django.db.models import CharField, FileField, BooleanField, Model, IntegerField
...
class SaveFileRelation(Model):
    file_id = IntegerField(verbose_name="文件ID", db_index=True)
    model_name = CharField(max_length=128, verbose_name="存储模型")
    relation_id = IntegerField(verbose_name="关联模型ID")
    field_name = CharField(max_length=128, verbose_name="存储字段")
