...
from apps.vadmin.system.views import DictDataModelViewSet, DictDetailsModelViewSet, \
    ...
    OperationLogModelViewSet, CeleryLogModelViewSet, SystemInfoApiView, SaveFileListViewSet
...
router.register(r'savefilelist', SaveFileListViewSet)
...
urlpatterns = [
    ...
    # 根据id下载文件
    re_path('savefile/download_file/', SaveFileModelViewSet.as_view({'get': 'download_file', })),
    # 获取系统信息cpu、内存、硬盘
