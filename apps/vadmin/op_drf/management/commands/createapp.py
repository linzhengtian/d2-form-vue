    ...
    def handle(self, *args, **options):
        ...
        for name in app_name:
            ...
            if os.path.exists(app_path):
                ...
                break
            source_path = os.path.join(settings.BASE_DIR, "apps", "vadmin", "template")
...
"""
            ...
            injection(os.path.join(settings.BASE_DIR, "d2Form", "settings.py"), f"    'apps.{dnames}',\n", "INSTALLED_APPS",
                      "]")

            # 注册app到 urls.py 中
            injection(os.path.join(settings.BASE_DIR, "d2Form", "urls.py"),
