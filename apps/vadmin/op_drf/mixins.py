...
from apps.vadmin.utils.file_util import delete_relative_files
...
class DestroyModelMixin(mixins.DestroyModelMixin):
    ...
    def perform_destroy(self, instance):
        # 字典处理
        for attachment in getattr(self.destroy_serializer_class or self.serializer_class, "find_attachment_fields")():
            for i in instance:
                delete_relative_files(self.basename, attachment, i.id)
        instance.delete()
